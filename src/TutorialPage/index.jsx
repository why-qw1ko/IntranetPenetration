    ...
    <div className="content-wrap">
      ...
      <div className="page">
        <div className="tutorial-page">
          ...
          <div className="tutorial-section">
            ...
            <div className="tutorial-card">
              ...
              <ul className="tutorial-steps">
                ...
                <li><b>连接速度慢</b> — DevTunnel 服务器在海外，国内访问可能有延迟。如需更快的速度，建议使用 Frp 自建穿透。</li>
          ...
          {/* ====== Frp 教程 ====== */}
          <div className="tutorial-section">
            <div className="tutorial-section-title"><Link2 size={20} /> Frp 自建内网穿透教程</div>
...
curl -fsSL https://ghproxy.com/https://raw.githubusercontent.com/fatedier/frp/master/install.sh | bash`}</div>
              <p style={{ fontSize: 13, color: 'var(--text)', lineHeight: 1.8, marginBottom: 10 }}>
...
sudo chmod +x /usr/local/bin/frps`}</div>
...
# 查看运行状态
sudo systemctl status frps`}</div>
            ...
            <div className="tutorial-card">
              ...
              <ol className="tutorial-steps" start="6">
                <li>在代理列表中点击「启动」，连接成功后即可通过服务器 IP + 端口（或域名）访问本地服务。</li>
              </ol>
            </div>
          ...
          <div className="tutorial-section">
            ...
            <div className="tutorial-card">
              ...
              <FaqItem k="faq5" q="穿透的速度取决于什么？">
                ...
                <p style={{ marginTop: 8 }}>DevTunnel 适合调试和演示，Frp 自建适合长期使用和对速度有要求的场景。</p>
              </FaqItem>
